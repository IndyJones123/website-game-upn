...
export default function Home() {
    ...
    return (
        <main className="relative w-screen bg-[#141414]">
            {isLoading && (
            ...
            <div className="h-full px-44 flex flex-col gap-10" id="list-games">
                <div className="mt-10">
                ...
                <button
                    className="bg-[#FF4C29] text-white flex items-center p-3 gap-3 rounded-md cursor-pointer w-[170px]"
                    onClick={() => {
                        setIsLoading(true);
                ...
                >
                    ...
                    <h1 className="font-semibold">Tambah Game</h1>
                </button>
